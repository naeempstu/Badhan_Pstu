...
<div class="main-content">
    <section class="hero-section">
        ...
        <p>বাঁধন পবিপ্রবি ইউনিট একটি সামাজিক ও অরাজনৈতিক সংগঠন যা পটুয়াখালী বিজ্ঞান ও প্রযুক্তি বিশ্ববিদ্যালয়ে সক্রিয়ভাবে কাজ করে যাচ্ছে ।</p>
    </section>
    ...
    <div class="about-cards">
        <div class="card">
            ...
            <br>
            <h3>(পবিপ্রবি ইউনিট)</h3>
            <p>বাধন পবিপ্রবি ইউনিটের যাত্রা শুরু হয় ২০০৮ সাল থেকে।</p>
        </div>
